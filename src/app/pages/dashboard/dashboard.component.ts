...
export class DashboardComponent implements OnInit {
  ...
  cards: InfoCard[]=[
    ...
    {title:'Customers', content:'321', cardClass:'card-header-success', footer:'footer 2', icon:'face', routerLink:'/customers'},
    {title:'Orders', content:'202', cardClass:'card-header-danger', footer:'footer 3', icon:'list_alt', routerLink:'/orders'},
